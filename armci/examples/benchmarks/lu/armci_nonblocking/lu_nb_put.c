...
#define DEFAULT_N                       32768
#define DEFAULT_B                       256
#define MAXPROC 16384 /* Maximum number of processors */
...
int doprint = 0; /* make it 1 to see LU decomposition output */

/* Buffers for pre-fetched data */
double **bufr, **bufc;
...
/* Function lu0: implements the serial algo on one diag block (*a)   */
